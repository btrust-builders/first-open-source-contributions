...
[![Discord](https://img.shields.io/badge/Discord-7289DA?style=for-the-badge&logo=discord&logoColor=white)](https://www.btrust.tech/builders/discord)
[![Open Source Love](https://img.shields.io/badge/Open_Source-gray?style=for-the-badge&logo=undertale&logoColor=EE0000)](https://github.com/btrust-builders/first-open-source-contributions)
...
This project aims to simplify and guide beginners through making their first open source contribution. If you're looking to make your first open source contribution, follow the steps below.
...
Now clone the forked repository to your computer. Go to your forked repository on GitHub, click on the `Code` button, select the `SSH` tab, and then click the _copy to clipboard_ icon.
...
where `your-github-username` is your actual GitHub username. Here you're copying the contents of the first-open-source-contributions repository from GitHub to your computer.
...
If you see the error message "Git: `switch` is not a git command. See `git –help`", you're likely using an older version of git.
...
Now open `Contributors.md` file in a text editor, add your name to it. Don't add it at the beginning or end of the file. Put it anywhere in between. Save the file when you're done.
...
Your changes will be merged into the main branch of this project. You will receive a notification email once the changes have been merged.


## Where to go from here?

Congratulations! You've just completed the standard _fork → clone → edit → pull request_ workflow that you'll often encounter as an open source contributor!
...
Now let's get you started with contributing to other open source projects. We've compiled a list of Bitcoin open source projects with easy issues you can get started on. Check out [curated Bitcoin open source projects](https://bitcoindevs.xyz/projects) or [good first issues](https://bitcoindevs.xyz/good-first-issues).
